-- =====================================================
-- MIGRACIÓN CONSOLIDADA PARA ZENTRADE AI
...
CREATE INDEX IF NOT EXISTS idx_trading_decisions_status ON trading_decisions(status);
...
CREATE INDEX IF NOT EXISTS idx_trade_results_user ON trade_results(user_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_learnings_importance ON ai_learnings(importance_score DESC);
...
CREATE INDEX IF NOT EXISTS idx_wellness_user_date ON wellness_tracking(user_id, date DESC);
...
-- ÍNDICES VECTORIALES
-- =====================================================
CREATE INDEX IF NOT EXISTS idx_trading_decisions_embedding 
  ON trading_decisions 
  USING ivfflat (embedding vector_cosine_ops)
  WITH (lists = 100);

CREATE INDEX IF NOT EXISTS idx_trade_results_embedding 
  ON trade_results 
  USING ivfflat (embedding vector_cosine_ops)
  WITH (lists = 100);
...
-- =====================================================
DROP POLICY IF EXISTS "Users can view own config" ON trading_config;
CREATE POLICY "Users can view own config" ON trading_config
  FOR SELECT USING (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can insert own config" ON trading_config;
...
DROP POLICY IF EXISTS "Users can update own config" ON trading_config;
...
-- =====================================================
DROP POLICY IF EXISTS "Users can view own decisions" ON trading_decisions;
CREATE POLICY "Users can view own decisions" ON trading_decisions
  FOR SELECT USING (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can insert own decisions" ON trading_decisions;
CREATE POLICY "Users can insert own decisions" ON trading_decisions
  FOR INSERT WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can update own decisions" ON trading_decisions;
...
-- =====================================================
DROP POLICY IF EXISTS "Users can view own results" ON trade_results;
CREATE POLICY "Users can view own results" ON trade_results
  FOR SELECT USING (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can insert own results" ON trade_results;
CREATE POLICY "Users can insert own results" ON trade_results
  FOR INSERT WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can update own results" ON trade_results;
...
-- =====================================================
DROP POLICY IF EXISTS "Users can view own learnings" ON ai_learnings;
CREATE POLICY "Users can view own learnings" ON ai_learnings
  FOR SELECT USING (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can insert own learnings" ON ai_learnings;
CREATE POLICY "Users can insert own learnings" ON ai_learnings
  FOR INSERT WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001');

DROP POLICY IF EXISTS "Users can update own learnings" ON ai_learnings;
