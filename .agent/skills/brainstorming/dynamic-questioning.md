...
```markdown
âŒ BAD: "What authentication method?"
...
```markdown
âŒ ASSUMPTION: "User probably wants Stripe for payments"
...
- High-volume social apps: 1000 users Á— 10 photos Á— 2MB = 20GB storage
