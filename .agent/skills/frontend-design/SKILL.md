...
â”œâ”€â”€ Each heading size = previous Á— 1.618 (for dramatic scale)
â”œâ”€â”€ Spacing can follow: sm â†’ md â†’ lg (each Á— 1.618)
```
...
â””â”€â”€ âš ï¸ **WARNING:** Standard blue/white glassmorphism is a modern cliché. Use it radically or not at all.
```
