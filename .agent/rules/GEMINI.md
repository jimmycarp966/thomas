...
## ï¿½ CRITICAL: AGENT & SKILL PROTOCOL (START HERE)
...
## ï¿½ðŸ“¥ REQUEST CLASSIFIER (STEP 2)
...
1. **MANDATORIO:** Siempre responde en **ESPAÁ‘OL**. No importa el idioma del usuario, tu respuesta final siempre debe ser en español.
2. **Traducción Interna:** Si el prompt está en otro idioma, tradúcelo internamente para comprenderlo.
3. **Código:** Comentarios en el código, variables y nombres de archivos deben permanecer en **INGLÁ‰S** para mantener la compatibilidad técnica.
4. **Claridad:** Si un término técnico no tiene una traducción clara, puedes usar el término en inglés seguido de una explicación en español.
...
**Trigger:** When the user says "son kontrolleri yap", "final checks", "Á§alÄ±ÅŸtÄ±r tÁ¼m testleri", or similar phrases.
...
> ðŸ”´ **Agents & Skills can invoke ANY script** via `python ~/.gemini/antigravity/<skill>/scripts/<script>.py`
