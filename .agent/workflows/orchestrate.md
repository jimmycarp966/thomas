...
---
description: Coordina múltiples agentes para tareas complejas. Ášsalo para análisis multiperspectiva, revisiones exhaustivas o tareas que requieren diferentes dominios de experiencia.
---
...
**CONTEXT:**
- User Request: "Á–ÄŸrenciler iÁ§in sosyal platform, mock data ile"
- Decisions: Tech=Vue 3, Layout=Grid Widget, Auth=Mock, Design=GenÁ§ Dinamik
